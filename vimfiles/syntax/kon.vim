" Vim syntax file
" Language:     Organi	
" Maintainer:   Philip Lapczynski	
" Last Change:  2006-03-23
...
syn keyword	cConditional	if else switch endswi BATCH COPY END FILTER NEXT SPECIAL REPLACE INCLUDE PATH
...
" Accept %: for # (C99)
syn region	cPreCondit	start="^\s*\(%:\|#\)\s*\(if\|ifdef\|ifndef\|elif\|ifset\|set\)\>" skip="\\$" end="$" end="//"me=s-1 contains=cComment,cCppString,cCharacter,cCppParen,cParenError,cNumbers,cCommentError,cSpaceError
